...
?>
        ...
        <form action="dailyform.php" method="GET" class="form-inline">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">ການບັນທຶກຊີວິດ</h3>
              </div>
              <?php 
include("./includes/db.php");
            ...
            <table class="table table-striped ">
              ...
              <tbody>
                ...
                if (isset($_GET['query'])) {
                  ...
                  $sql = "SELECT * FROM pdaily WHERE is_delete=0 AND id LIKE '%$query%' OR five_six LIKE '%$query%' OR six_seven LIKE '%$query%' OR seven_eight LIKE '%$query%' OR eight_nine LIKE '%$query%' OR nine_ten LIKE '%$query%' OR ten_eleven LIKE '%$query%' OR eleven_twelve LIKE '%$query%' OR twelve_thirteen LIKE '%$query%' OR thirteen_fourteen LIKE '%$query%' OR fourteen_fifteen LIKE '%$query%' OR fifteen_sixteen LIKE '%$query%' OR sixteen_seventeen LIKE '%$query%' OR seventeen_eighteen LIKE '%$query%' OR eighteen_nineteen LIKE '%$query%' OR nineteen_twenty LIKE '%$query%' OR twenty_twentyone LIKE '%$query%' OR twentyone_twentytwo LIKE '%$query%' OR twentytwo_twentythree LIKE '%$query%' OR days LIKE '%$query%'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  if (mysqli_num_rows($result) > 0) {
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                          ...
                          echo "<tr><td>".$row['id'] ."</td><td>". $row['five_six'] ."</td><td>". $row['six_seven'] ."</td><td>". $row['seven_eight'] ."</td><td>". $row['eight_nine'] ."</td><td>". $row['nine_ten'] ."</td><td>". $row['ten_eleven'] ."</td><td>". $row['eleven_twelve'] ."</td><td>". $row['twelve_thirteen'] ."</td><td>". $row['thirteen_fourteen'] ."</td><td>". $row['fourteen_fifteen'] ."</td><td>". $row['fifteen_sixteen'] ."</td><td>". $row['sixteen_seventeen'] ."</td><td>". $row['seventeen_eighteen'] ."</td><td>". $row['eighteen_nineteen'] ."</td><td>". $row['nineteen_twenty'] ."</td><td>". $row['twenty_twentyone'] ."</td><td>". $row['twentyone_twentytwo'] ."</td><td>". $row['twentytwo_twentythree'] ."</td><td>". $row['timestamp'] ."</td><td>". $row['days'] ."</td>". "</tr>";
                      }
                  } else {
                ...
                <tr>
                  ...
                  ?></td>
                  <td><a class="btn btn-warning" href="editdaily.php?id=<?php echo $row['id'];?>"><i class="fas fa-edit"></i></a>&nbsp;<a onclick="confirmDelete(<?php echo $row['id'];?>)" class="btn btn-danger"><i class="fas fa-times"></i></a><a href="dailyitemprintpdf.php?id=<?php echo$row['id']?>" class="btn btn-success"><i class="fas fa-print"></i></a></td>
                </tr>
               <?php } ?>
