...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    $sql = "SELECT * FROM notes WHERE is_delete = 0 AND image IS NOT NULL ORDER BY id DESC  limit 2";
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <a href="./notedetailimage.php" class="btn btn-primary"><i class="fas fa-arrow-circle-right"></i>&nbsp;ລາຍລະອຽດ</a>
            </div>
            <div class="col-sm-6">
              <div class="row">
                <div class="col-md-6">
                  <form action="noteimage.php" method="GET" class="form-inline">
                    <select name="query" id="" class="form-control">
                      ...
                      <option value="ການອອກແບບ">ການອອກແບບ</option>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <h1 class="text-center">ຟອມບັນທຶກດ້ວຍຮູບພາບ</h1>
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">ອັບໂຫຼດຮູບພາບ</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="insertnoteimage.php" enctype="multipart/form-data">
                  <div class="card-body">
      ...
      echo '<img src="' . $filePath . '" alt="Uploaded Image" width="100">';?></td>
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          Swal.fire({
            ...
            window.location.href = 'deletenoteimage.php?id=' + $id;
          });
        }
      });
    }
