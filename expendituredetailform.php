    ...
    <div class="content-wrapper">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="nav-item">
                  ...
                  <form action="expendituredetailform.php" method="GET" class="form-inline">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <h1 class="text-center text-bold text-danger">ລາຍລະອຽດລາຍຈ່າຍ</h1><br>
          <div class="row">
            <div class="col-md-9"></div>
            <div class="col-md-2">
              <a href="./expenditureprintpdf.php" class="btn btn-danger"><i class="fa fa-print"></i>&nbsp;Print PDF</a><br>
            </div>
