            ...
            <div class="col-md-12">
              ...
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">ແກ້ໄຂຂໍ້ມູນຊີວິດ</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="form-group ml-2">
                        ...
                        <input type="text" name="five_six" class="form-control" value="<?php echo $row['five_six'] ?>"
                          id="exampleInputEmail1" required>
                      </div>
                      <div class="form-group ml-2">
                        <label for="exampleInputPassword1">6:00-7:00</label>
                        <input type="text" name="six_seven" class="form-control" value="<?php echo $row['six_seven'] ?>"
                          id="exampleInputPassword1">
                      </div>

                      <div class="form-group ml-2">
                        <label for="exampleInputEmail1">7:00-8:00</label>
                        <input type="text" name="seven_eight" class="form-control"
                          value="<?php echo $row['seven_eight'] ?>" id="exampleInputEmail1">
                      </div>
                      <div class="form-group ml-2">
                        <label for="exampleInputPassword1">8:00-9:00</label>
                        <input type="text" name="eight_nine" class="form-control"
                          value="<?php echo $row['eight_nine'] ?>" id="exampleInputPassword1">
                      </div>
                      <div class="form-group ml-2">
                        <label for="exampleInputEmail1">9:00-10:00</label>
                        <input type="text" name="nine_ten" class="form-control" value="<?php echo $row['nine_ten'] ?>"
                          id="exampleInputEmail1">
                      </div>
                      <div class="form-group ml-2">
                        <label for="exampleInputEmail1">10:00-11:00</label>
                        <input type="text" name="ten_eleven" class="form-control"
                          value="<?php echo $row['ten_eleven'] ?>" id="exampleInputEmail1">
                      </div>
                      <div class="form-group ml-2">
                        <label for="exampleInputPassword1">11:00-12:00</label>
                        <input type="text" name="eleven_twelve" class="form-control"
                          value="<?php echo $row['eleven_twelve'] ?>" id="exampleInputPassword1">
                      </div>

                      <div class="form-group ml-2">
                        <label for="exampleInputEmail1">12:00-13:00</label>
                        <input type="text" name="twelve_thirteen" class="form-control"
                          value="<?php echo $row['twelve_thirteen'] ?>" id="exampleInputEmail1">
                      </div>
                      <div class="form-group ml-2">
                        <label for="exampleInputPassword1">13:00-14:00</label>
                        <input type="text" name="thirteen_fourteen" class="form-control"
                          value="<?php echo $row['thirteen_fourteen'] ?>" id="exampleInputPassword1">
                      </div>
                      <div class="form-group ml-2">
                        <label for="exampleInputEmail1">14:00-15:00</label>
                        <input type="text" name="fourteen_fifteen" class="form-control"
                          value="<?php echo $row['fourteen_fifteen'] ?>" id="exampleInputEmail1">
                      </div>
                      <div class="form-group ml-2">
                        <label for="exampleInputEmail1">15:00-16:00</label>
                        <input type="text" name="fifteen_sixteen" class="form-control"
                          value="<?php echo $row['fifteen_sixteen'] ?>" id="exampleInputEmail1">
                      </div>
                      <div class="form-group ml-2">
                        <label for="exampleInputPassword1">16:00-17:00</label>
                        <input type="text" name="sixteen_seventeen" class="form-control"
                          value="<?php echo $row['sixteen_seventeen'] ?>" id="exampleInputPassword1">
                      </div>

                      <div class="form-group ml-2">
                        <label for="exampleInputEmail1">17:00-18:00</label>
                        <input type="text" name="seventeen_eighteen" class="form-control"
                          value="<?php echo $row['seventeen_eighteen'] ?>" id="exampleInputEmail1">
                      </div>
                      <div class="form-group ml-2">
                        <label for="exampleInputPassword1">18:00-19:00</label>
                        <input type="text" name="eighteen_nineteen" class="form-control"
                          value="<?php echo $row['eighteen_nineteen'] ?>" id="exampleInputPassword1">
                      </div>
                      <div class="form-group ml-2">
                        <label for="exampleInputEmail1">19:00-20:00</label>
                        <input type="text" name="nineteen_twenty" class="form-control"
                          value="<?php echo $row['nineteen_twenty'] ?>" id="exampleInputEmail1">
                      </div>

                      <div class="form-group ml-2">
                        <label for="exampleInputEmail1">20:00-21:00</label>
                        <input type="text" name="twenty_twentyone" class="form-control"
                          value="<?php echo $row['twenty_twentyone'] ?>" id="exampleInputEmail1">
                      </div>
                      <div class="form-group ml-2">
                        <label for="exampleInputPassword1">21:00-22:00</label>
                        <input type="text" name="twentyone_twentytwo" class="form-control"
                          value="<?php echo $row['twentyone_twentytwo'] ?>" id="exampleInputPassword1">
                      </div>

                      <div class="form-group ml-2">
                        <label for="exampleInputEmail1">22:00-23:00</label>
                        <input type="text" name="twentytwo_twentythree" class="form-control"
                          value="<?php echo $row['twentytwo_twentythree'] ?>" id="exampleInputEmail1">
                      </div>
                      <div class="form-group ml-2">
                        <label for="exampleInputPassword1">23:00-5:00</label>
                        <input type="text" name="twentythree_five" class="form-control"
                          value="<?php echo $row['twentythree_five'] ?>" id="exampleInputPassword1">
