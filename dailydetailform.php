...
?>
        ...
        <form action="dailydetailform.php" method="GET" class="form-inline">
    ...
    <?php 
include("./includes/db.php");
$sql = "SELECT * FROM pdaily WHERE is_delete=0 AND income IS NULL AND expenditure IS NULL ORDER BY id DESC";
...
?>
    ...
    <section class="content">
      <div class="container-fluid">
        <h1 class="text-center text-bold text-primary">ລາຍລະອຽດແຕ່ລະວັນຂອງຂ້ອຍຕັ້ງແຕ່ (01/01/2024)</h1><br>
