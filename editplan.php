...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "UPDATE plan SET  plan_name='$plan_name', percent='$percent', active='$active', status='$status' WHERE id=$id";
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <h1 class="text-center">ແກ້ໄຂແຜນການ</h1>
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">ແກ້ໄຂຂໍ້ມູນແຜນການ</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="">ຊື່ແຜນການ</label>
                                <input type="text" class="form-control" name="plan_name" value="<?php echo $row['plan_name']?>">
                            </div>
                            <div class="col-md-6">
                                <label for="">ຈຳນວນເປີເຊັນ</label>
                                <input type="number" class="form-control" name="percent" value="<?php echo $row['percent']?>">
                            </div>
                            
                        </div>
                        <div class="row">
                        <div class="col-md-6">
                                <label for="">ການເຄື່ອນໄຫວ</label>
                                <input type="number" class="form-control" name="active" value="<?php echo $row['active']?>">
                            </div>
                        <div class="col-md-6">
