...
<script>
  ...
  if (isSuccess) {
    ...
    echo "<audio id='myAudio'><source src='./sounds/ຍິນດີຕ້ອນຮັບເຂົ້າສູ່ລະບົບເດຍລີ.wav' type='audio/wav'>Your browser does not support the audio element.</audio>";
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <marquee class="m-0 text-primary">
                <h1 class="text-bold">ຍິນດີຕ້ອນຮັບເຂົ້າສູ່ລະບົບ DAILY</h1>
              </marquee>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <tbody>
                  ...
                  <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                      ...
                      ?></td>
                      <td><a class="btn btn-warning" href="editdaily.php?id=<?php echo $row['id']; ?>"><i
                            class="fas fa-edit"></i></a>&nbsp;<a onclick="confirmDelete(<?php echo $row['id']; ?>)"
