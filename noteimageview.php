...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <div class="row">
                <div class="col-md-6">
                  <form action="noteform.php" method="GET" class="form-inline">
              ...
              <table class="table table-striped ">
                ...
                <tbody>
                  ...
                  if (isset($_GET['query'])) {
                    ...
                    $sql = "SELECT * FROM notes WHERE is_delete=0 AND id LIKE '%$query%' ";
                    $result = mysqli_query($conn, $sql);
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<tr>" . "<td>" . $row['id'] . "</td>" . "<td><b>" . $row['image'] . "</b></td>" . "<td><b class='text-primary'>" . $row['modules'] . "</b></td>" . "<td>" . $row['timestamp'] . "</td>" . "</tr>";
                      }
                    } else {
      ...
      echo '<img src="' . $filePath . '" alt="Uploaded Image" width="400">';?></td>
