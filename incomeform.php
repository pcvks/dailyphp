...
$sql = "SELECT * FROM pdaily where is_delete = 0 AND income is not NULL ORDER BY id DESC limit 5";
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <a href="./incomedetailform.php" class="btn btn-success"><i class="fas fa-arrow-circle-right"></i>&nbsp;ລາຍລະອຽດ</a>
          </div>
          <div class="col-sm-6">
        ...
        <form action="incomeform.php" method="GET" class="form-inline">
    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="col-md-6">
            ...
            <h1 class="text-center">ຟອມບັນທຶກລາຍຮັບ</h1>
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">ການເພີ່ມລາຍຮັບ</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="insertincome.php">
                <div class="card-body">
                 
                  <div class="row">
                  <div class="form-group">
                    <label for="exampleInputEmail1">ຈຳນວນເງິນ</label>
                    <input type="number" name="income" class="form-control" id="exampleInputEmail1" required placeholder="ຈຳນວນເງິນ">
                    </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <div class="form-group">
                    <label for="exampleInputPassword1">ເຫດຜົນ</label>
                    <input type="text" name="in_reason" class="form-control" id="exampleInputPassword1" required placeholder="ເຫດຜົນທີ່ໄດ້ມາຈາກ">
                  </div>&nbsp;&nbsp;&nbsp;
                  <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-success">ສົ່ງຟອມ</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
            ...
            <table class="table table-striped ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo "<b class='text-success'>".$row['income']." ₭";"</b>"; ?></td>
