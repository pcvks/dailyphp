...
$sql = "SELECT * FROM plan WHERE is_delete = 0 AND status = 1";
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <form action="plansuccessform.php" method="GET" class="form-inline">
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- <img src="./image/congratulation.png" style="width: 20%; height:20%;" alt=""> -->
        <h1 class="text-center text-bold text-success">ແຜນການປີນີ້ທີ່ສຳເລັດແລ້ວ</h1><br>
        <div class="row">
            <div class="col-md-9"></div>
            <div class="col-md-2">
              <a href="./plansuccessprintpdf.php" class="btn btn-success"><i class="fa fa-print"></i>&nbsp;Print PDF</a><br>
            </div>
            ...
            <table class="table table-striped ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo "<b class='text-success'>".$row['plan_name']."</b>"; ?></td>
