...
$sql = "SELECT * FROM notes WHERE is_delete = 0 ORDER BY id DESC  limit 2";
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div class="navbar-search-block">
          <form class="form-inline" action="noteform.php" method="GET">
    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="col-md-6">
            ...
            <h1 class="text-center">ຟອມບັນທຶກທີ່ສຳຄັນ</h1>
            <div class="card card-primary">
              ...
              <form method="POST" action="insertnote.php">
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" id="" cols="30" rows="10" placeholder="ເນື້ອໃນຕ່າງໆ"></textarea>
                  </div>
                  </div>
              ...
              <tbody>
                <?php 
                 ...
                 if (isset($_GET['query'])) {
                   ...
                   $sql = "SELECT * FROM notes WHERE is_delete=0 AND content LIKE '%$query%' ";
                   $result = mysqli_query($conn, $sql);
                   ...
                   if (mysqli_num_rows($result) > 0) {
                       ...
                       while ($row = mysqli_fetch_assoc($result)) {
                           ...
                           echo "<tr>"."<td>".$row['id'] ."</td>"."<td><b>". $row['content'] ."</b></td>". "<td>".$row['timestamp'] ."</td>"."</tr>";
                       }
                   } else {
                ...
                <tr>
                  ...
                  <td><a class="btn btn-warning" href="editnote.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-edit"></i></a>&nbsp;<a onclick="confirmDelete(<?php echo $row['id'];?>)" class="btn btn-danger"><i class="fas fa-times"></i></a></td>
                </tr>
               <?php } ?>
              </tbody>
            </table>
