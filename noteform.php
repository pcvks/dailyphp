...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    $sql = "SELECT * FROM notes WHERE is_delete = 0 AND image IS NULL ORDER BY id DESC  limit 2";
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <textarea name="content" id="" cols="30" rows="10" placeholder="ເນື້ອໃນຕ່າງໆ" required></textarea>
                        </div>
                      </div>
                      <div class="col-md-6">
