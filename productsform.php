...
$sql = "SELECT m_pay - sale_price as m_return, id, sale_price, m_pay FROM products";
              ...
              <form method="POST" action="insertproduct.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="sale_price" class="form-control" id="exampleInputEmail1" required placeholder="ລາຄາສິນຄ້າ">
                    </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <div class="form-group">
            ...
            <table class="table table-striped ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $row['sale_price']; ?> ກີບ</td>
