...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    $sql = "SELECT * FROM pdaily where DATE(timestamp) = CURDATE() AND is_delete = 0 AND expenditure is not NULL ORDER BY id DESC ";
    ...
    <div class="content-wrapper">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="nav-item">
                  ...
                  <form action="expendituretodayform.php" method="GET" class="form-inline">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <h1 class="text-center text-bold text-danger">ລາຍຈ່າຍໃນມື້ນີ້</h1><br>
          <div class="row">
            <div class="col-md-9"></div>
            <div class="col-md-2">
              <a href="./expendituretodayprintpdf.php" class="btn btn-danger"><i class="fa fa-print"></i>&nbsp;Print PDF</a><br>
            </div>
